...
class Design_7_7_movement extends ActorScript
{
	...
	public function _customEvent_accelLeft():Void
	{
		...
		{
			Engine.engine.setGameAttribute("lateralSpeed", _turnSpeed);
			Engine.engine.setGameAttribute("virtualX", (Engine.engine.getGameAttribute("virtualX") - 1));
		}
	}
	...
	{
		if(((Engine.engine.getGameAttribute("virtualX") + getScreenWidth()) > 499))
		{
	...
	public function _customEvent_touchLeftRight():Void
	{
		...
		{
			_customEvent_touchRight();
		}
		else
		{
			_customEvent_touchLeft();
		}
	}
